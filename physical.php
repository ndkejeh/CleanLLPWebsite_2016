    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 nopadding">
                <img class="img-responsive" src="images/PhysicalBanner.png" alt="Hardware Banner">
            </div>
        </div>
        <div class="row">
            <div class="col-xs-12 nopadding">
        ...
        <div class="row services-row-small hidden-md hidden-sm hidden-lg" id="services-row-small-2">
            ...
            <div class="col-xs-5 nopadding">
                <p class="services-blurb">With our expertise
                in engineering and science, we build clients' ideas from prototypes to market ready.</p>
            </div>
        </div>
