            ...
            <div class="col-xs-12 nopadding">
                <div class="body-frame">
                    ...
                    molestie posuere elit. Sed at nulla sit amet 
                        ipsum tincidunt tempor vel vitae sapien.</p> 
                    <p class="body">Curabitur nibh libero, pulvinar ac leo sit amet, 
                    ...
                    commodo ultrices velit. Proin odio nisi, 
                    tincidunt eu nunc non, vulputate dictum velit.Lorem ipsum dolor sit amet, consectetur 
                        adipiscing elit. Nulla non nisl justo. </p>
                    <p class="body">Aenean molestie molestie nunc. Morbi sed 
                    dolor mollis, condimentum ligula pharetra, 
                    posuere felis. Morbi id ex hendrerit, 
                    commodo lacus eu, venenatis lectus. 
                    Nullam felis lectus, molestie et velit sed, 
        ...
        <div class="row hidden-xs">
         ...
         <div class="row">
            <div class="col-xs-3 nopadding">
                <a href="okiki.php"><img class="img-responsive slide-over" src="work/images/Preview/Quip_Img_400.png"></a>
                <p class="img-info">Quip</p>
            </div>
            <div class="col-xs-3 nopadding">
                <a href="tina.php"><img class="img-responsive slide-over" src="work/images/Preview/Carib_Img_400.png"></a>
                <p class="img-info">Carib Connect</p>
            </div>
            <div class="col-xs-3 nopadding">
                <a href="flemmings.php"><img class="img-responsive slide-over" src="work/images/Preview/Solis_Img.jpg"></a>
